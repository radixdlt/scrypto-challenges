    ...
    impl CodeExecutionSystem {
        ...
        pub fn instantiate_global(
            ...
            let rules = AccessRules::new()
                ...
                .method("add_access_badge", rule!(require(admin_badge)));
...
impl CodeExecution {
        ...
        F: FnOnce(),
    {
        for required_badge in required_badges {
            let proof = available_badges
                .get(required_badge)
                .expect("Required badge is not available")
                .create_proof();
