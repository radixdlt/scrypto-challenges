...
//     let amount_rewards_subscription: Decimal = dec!("100");
...
//     test_runner.set_current_epoch(25);
//     test_runner.execute_manifest(new_membership_2_manifest, vec![public_key_2.into()]);

//     let vote_manifest = ManifestBuilder::new(&NetworkDefinition::simulator())
//         .call_method(account_component_2, "lock_fee", args!(dec!("100")))
//         .withdraw_from_account_by_ids(
//             &membership_2_bt_id,
//             mint_membership_address,
...
//                         account_component_2,
//                     )
//                     .pop_from_auth_zone(|build, vote_proof| {
//                         build.call_method(
//                             component,
//                             "vote_proposal",
//                             args!(
...
//     let recept = test_runner.execute_manifest(vote_manifest, vec![public_key_2.into()]);
...
// #[test]
// fn test_error_vote_insufficient_amount() {
//     let mut store: TypedInMemorySubstateStore = TypedInMemorySubstateStore::with_bootstrap();
...
//     let proposal_id = String::from("78347834327432h327327423");
...
// #[test]
// fn test_error_choice_does_not_exist() {
//     let mut store: TypedInMemorySubstateStore = TypedInMemorySubstateStore::with_bootstrap();
...
// #[test]
// fn test_error_voting_not_started() {
//     let mut store: TypedInMemorySubstateStore = TypedInMemorySubstateStore::with_bootstrap();
...
//     test_runner.set_current_epoch(19);
//     let recept = test_runner.execute_manifest(new_membership_2_manifest, vec![public_key_2.into()]);
...
//     test_runner.set_current_epoch(39);
//     let recept = test_runner.execute_manifest(new_membership_2_manifest, vec![public_key_2.into()]);
