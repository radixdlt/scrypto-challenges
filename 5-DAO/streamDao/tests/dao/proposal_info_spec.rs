...
fn test_vote_show_data() {
    ...
    let show_proposal_manifest = ManifestBuilder::new(&NetworkDefinition::simulator())
        .call_method(account_component, "lock_fee", args!(dec!("100")))
        .call_method(
            component,
            "show_proposal_data",
    ...
    let receipt = test_runner.execute_manifest(show_proposal_manifest, vec![public_key.into()]);
