...
blueprint! {
    ...
    impl Escrow {
        ...
        pub fn instantiate_escrow(
            ...
            assert_ne!(
                to_be_paid_by_party_1,
                to_be_paid_by_party_2,
                "The two resource specifiers cannot equal to one another!"
            );
            ...
            let escrow_obligations: Bucket = ResourceBuilder::new_non_fungible()
                ...
                .metadata("team-member-1-github-username", "attilacsanyi")
                .metadata("team-member-2-github-username", "bencem")
                .metadata("team-member-3-github-username", "dark1618")
                .metadata("team-member-4-github-username", "qmlnik")
                .initial_supply([
                    (
        ...
        pub fn deposit(&mut self, obligation_badge: Proof, mut funds: Bucket) -> Bucket {
            ...
            let obligation: EscrowObligation = obligation_badge
                .non_fungible().data();
        ...
        pub fn withdraw(&mut self, obligation_badge: Proof) -> Bucket {
            assert!(
                ...
                "You can not withdraw your fund unless the escrow has been concluded!"
            );
