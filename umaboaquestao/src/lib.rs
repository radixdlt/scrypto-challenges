    ...
    impl Escrow {
        ...
        pub fn instantiate_escrow(
            ...
            assert_ne!(
                ...
                "the two resource specifiers cannot equal one another"
            );
            ...
            let escrow_obligations: Bucket = ResourceBuilder::new_non_fungible()
                ...
                .metadata("description", "this resource describes the obligation of the 2 parties involved in the exchange")
                .initial_supply([
                    (
            ...
            return (escrow_obligations.resource_address(), escrow_obligations);
        }
