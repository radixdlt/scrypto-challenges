    ...
    impl TokenSale{
        pub fn new(price_per_token:Decimal) -> (ComponentAddress, Bucket){
            let bucket: Bucket = ResourceBuilder::new_fungible()
                .metadata("name","ATOMIC_COMMIT")
                .metadata("team-member-1-ticket-number", "40354007596475926249001")
                .metadata("team-member-2-ticket-number", "40522446396505192309001")
                .metadata("team-member-3-ticket-number", "40529771496506468649001")
                .divisibility(18)
