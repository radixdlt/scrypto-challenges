   ...
   impl Escrow {
       ...
       pub fn instantiate_escrow(
           ...
           to_be_paid_by_party_2: ResourceSpecifier,
            ...
            assert!(to_be_paid_by_party_1.validate().is_ok(), "party 1 not ok");
            assert!(to_be_paid_by_party_2.validate().is_ok(), "party 2 not ok");
            assert_ne!(to_be_paid_by_party_1, to_be_paid_by_party_2, "parties cannot be equal");
            ...
            let escrow_obligations: Bucket = ResourceBuilder::new_non_fungible()
                ...
                .metadata("description", "obligation of two involved parties")
                .metadata("team-member-1-github-username", "hehe100596")
                .metadata("team-member-2-github-username", "bitsandtea")
                .metadata("team-member-3-github-username", "schaschko")
                .metadata("team-member-4-github-username", "jammy-tea")
                .initial_supply([
                    (
       ...
       pub fn withdraw(&mut self, obligation_badge: Proof) -> Bucket {
            assert!(
                ...
                "you can not withdraw your funds unless escrow has been concluded"
            );
