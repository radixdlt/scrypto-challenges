   ...
   impl Escrow {
       ...
       pub fn instantiate_escrow(
           ...
           assert_ne!(
            ...
            "The two resource specifiers can not equal one another!"
           );/SebasKoel
           ...
           let escrow_obligations: Bucket = ResourceBuilder:: new_non_fungible()
                ...
                .metadata("team-member-1-github-username", "SebasKoel")
                .metadata("team-member-2-github-username", "koreem")
                .metadata("team-member-3-github-username", "tulp-tech")
                .metadata("team-member-4-github-username", "LeonLusic")
       ...
       pub fn withdraw(&mut self, obligation_badge: Proof) -> Bucket {
           ...
           assert!(
                ...
                "You cannot withdraw your funds unless the escrow has been concluded!"
            );
