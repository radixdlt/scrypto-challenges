    ...
    impl TokenSale {
        pub fn new(price_per_token: Decimal) -> (ComponentAddress, Bucket) {
                let bucket: Bucket = ResourceBuilder::new_fungible()
                    .metadata("name", "ForintInu")
                    .metadata("team-number-1-ticket-number", "4133409609")
                    .metadata("team-number-2-ticket-number", "4141251399")
                    .metadata("team-number-3-ticket-number", "4057738409")
                    .metadata("team-number-4-ticket-number", "4117118029")
