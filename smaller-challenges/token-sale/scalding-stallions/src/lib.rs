    ...
    impl TokenSale {
        pub fn new(price_per_token: Decimal) -> (ComponentAddress,Bucket) {
            let bucket: Bucket = ResourceBuilder::new_fungible()
                ...
                .metadata("name", "scalding-stallions")
                .metadata("symbol", "STAL")
                .metadata("team-member-1-ticket-number ", "#4085605059") 
                .metadata("team-member-2-ticket-number ", "#4017647489") 
                .metadata("team-member-3-ticket-number ", "#4017892189") 
                .metadata("team-member-4-ticket-number ", "#4073898299") 
