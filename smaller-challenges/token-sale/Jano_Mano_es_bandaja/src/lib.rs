    ...
    impl TokenSale {
        pub fn new(price_per_token: Decimal) -> (ComponentAddress, Bucket) {
            let bucket: Bucket = ResourceBuilder::new_fungible()
                .metadata("name", "Jano_Mano_es_bandaja")
                .metadata("team-member-1-ticket-number ", "41144253196608518929001")
                .metadata("team-member-2-ticket-number ", "40572951296514080099001")
