    ...
    impl TokenSale {
        pub fn new(price_per_token: Decimal) -> (ComponentAddress, Bucket) {
            let bucket: Bucket = ResourceBuilder::new_fungible()
                ...
                .metadata("name", "When Lambo Token")
                .metadata("team-member-1-ticket-number", "40688508996533005519001")
                .metadata("team-member-2-ticket-number", "40688508996533005529001")
                .metadata("team-member-3-ticket-number", "40769295896546082999001")
                .metadata("team-member-4-ticket-number", "40768996896546010199001")
                .metadata("symbol", "WLT")
