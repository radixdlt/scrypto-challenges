function ExchangeRatePic() {
    ...
    const SuperYieldNFTLogo = () => {
        return (
            <span className='exchange-amount-container'>
                ...
                <img
                    src="https://assets.floww.fi/images/logo/tp/white/yield_nft.svg"
                    alt="SuperYield"
                />
    ...
    const SuperLogo = () => {
        return (
            <span className='exchange-amount-container'>
                ...
                <img
                    src="https://assets.floww.fi/images/logo/tp/white/super_s.svg"
                    alt="SuperYieldNFT"
                />
    ...
    const SuperTrustLogo = () => {
        return (
            <span className='exchange-amount-container'>
                ...
                <img
                    src="https://assets.floww.fi/images/logo/tp/white/super_t.svg"
                    alt="SuperYield"
                />

                <h2>6 SUPER Trust Fund</h2>
    ...
    return (
        <span className="ExchangeRatePic">
