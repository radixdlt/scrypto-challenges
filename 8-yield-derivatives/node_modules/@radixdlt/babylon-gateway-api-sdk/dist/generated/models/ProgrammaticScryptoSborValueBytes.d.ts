 ...
 * @export
 */
export declare const ProgrammaticScryptoSborValueBytesKindEnum: {
 ...
 */
export declare function instanceOfProgrammaticScryptoSborValueBytes(value: object): boolean;
export declare function ProgrammaticScryptoSborValueBytesFromJSON(json: any): ProgrammaticScryptoSborValueBytes;
export declare function ProgrammaticScryptoSborValueBytesFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProgrammaticScryptoSborValueBytes;
export declare function ProgrammaticScryptoSborValueBytesToJSON(value?: ProgrammaticScryptoSborValueBytes | null): any;
