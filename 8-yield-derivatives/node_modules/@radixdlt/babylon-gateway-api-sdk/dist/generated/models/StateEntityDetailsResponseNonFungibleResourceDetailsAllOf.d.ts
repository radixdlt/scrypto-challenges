 ...
 * @export
 */
export declare const StateEntityDetailsResponseNonFungibleResourceDetailsAllOfTypeEnum: {
 ...
 */
export declare function instanceOfStateEntityDetailsResponseNonFungibleResourceDetailsAllOf(value: object): boolean;
export declare function StateEntityDetailsResponseNonFungibleResourceDetailsAllOfFromJSON(json: any): StateEntityDetailsResponseNonFungibleResourceDetailsAllOf;
export declare function StateEntityDetailsResponseNonFungibleResourceDetailsAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): StateEntityDetailsResponseNonFungibleResourceDetailsAllOf;
export declare function StateEntityDetailsResponseNonFungibleResourceDetailsAllOfToJSON(value?: StateEntityDetailsResponseNonFungibleResourceDetailsAllOf | null): any;
