 ...
 * @export
 */
export declare const NonFungibleResourcesCollectionItemVaultAggregatedAllOfAggregationLevelEnum: {
 ...
 */
export declare function instanceOfNonFungibleResourcesCollectionItemVaultAggregatedAllOf(value: object): boolean;
export declare function NonFungibleResourcesCollectionItemVaultAggregatedAllOfFromJSON(json: any): NonFungibleResourcesCollectionItemVaultAggregatedAllOf;
export declare function NonFungibleResourcesCollectionItemVaultAggregatedAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): NonFungibleResourcesCollectionItemVaultAggregatedAllOf;
export declare function NonFungibleResourcesCollectionItemVaultAggregatedAllOfToJSON(value?: NonFungibleResourcesCollectionItemVaultAggregatedAllOf | null): any;
