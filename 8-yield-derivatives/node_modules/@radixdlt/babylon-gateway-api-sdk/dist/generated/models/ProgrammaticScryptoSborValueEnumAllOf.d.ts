 ...
 * @export
 */
export declare const ProgrammaticScryptoSborValueEnumAllOfKindEnum: {
    readonly Enum: "Enum";
};
 ...
 */
export declare function instanceOfProgrammaticScryptoSborValueEnumAllOf(value: object): boolean;
export declare function ProgrammaticScryptoSborValueEnumAllOfFromJSON(json: any): ProgrammaticScryptoSborValueEnumAllOf;
export declare function ProgrammaticScryptoSborValueEnumAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProgrammaticScryptoSborValueEnumAllOf;
export declare function ProgrammaticScryptoSborValueEnumAllOfToJSON(value?: ProgrammaticScryptoSborValueEnumAllOf | null): any;
