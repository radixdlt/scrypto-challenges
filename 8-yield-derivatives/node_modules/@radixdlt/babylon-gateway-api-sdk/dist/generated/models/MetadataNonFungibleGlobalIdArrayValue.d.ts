 ...
 * @export
 */
export declare const MetadataNonFungibleGlobalIdArrayValueTypeEnum: {
 ...
 */
export declare function instanceOfMetadataNonFungibleGlobalIdArrayValue(value: object): boolean;
export declare function MetadataNonFungibleGlobalIdArrayValueFromJSON(json: any): MetadataNonFungibleGlobalIdArrayValue;
export declare function MetadataNonFungibleGlobalIdArrayValueFromJSONTyped(json: any, ignoreDiscriminator: boolean): MetadataNonFungibleGlobalIdArrayValue;
export declare function MetadataNonFungibleGlobalIdArrayValueToJSON(value?: MetadataNonFungibleGlobalIdArrayValue | null): any;
