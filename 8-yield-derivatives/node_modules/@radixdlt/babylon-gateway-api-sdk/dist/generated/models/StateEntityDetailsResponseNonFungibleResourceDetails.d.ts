 ...
 * @export
 */
export declare const StateEntityDetailsResponseNonFungibleResourceDetailsTypeEnum: {
 ...
 */
export declare function instanceOfStateEntityDetailsResponseNonFungibleResourceDetails(value: object): boolean;
export declare function StateEntityDetailsResponseNonFungibleResourceDetailsFromJSON(json: any): StateEntityDetailsResponseNonFungibleResourceDetails;
export declare function StateEntityDetailsResponseNonFungibleResourceDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): StateEntityDetailsResponseNonFungibleResourceDetails;
export declare function StateEntityDetailsResponseNonFungibleResourceDetailsToJSON(value?: StateEntityDetailsResponseNonFungibleResourceDetails | null): any;
