 ...
 * @export
 */
export declare const NonFungibleResourcesCollectionItemVaultAggregatedAggregationLevelEnum: {
 ...
 */
export declare function instanceOfNonFungibleResourcesCollectionItemVaultAggregated(value: object): boolean;
export declare function NonFungibleResourcesCollectionItemVaultAggregatedFromJSON(json: any): NonFungibleResourcesCollectionItemVaultAggregated;
export declare function NonFungibleResourcesCollectionItemVaultAggregatedFromJSONTyped(json: any, ignoreDiscriminator: boolean): NonFungibleResourcesCollectionItemVaultAggregated;
export declare function NonFungibleResourcesCollectionItemVaultAggregatedToJSON(value?: NonFungibleResourcesCollectionItemVaultAggregated | null): any;
