 ...
 * @export
 */
export declare const ProgrammaticScryptoSborValueMapAllOfKindEnum: {
    readonly Map: "Map";
};
 ...
 */
export declare function instanceOfProgrammaticScryptoSborValueMapAllOf(value: object): boolean;
export declare function ProgrammaticScryptoSborValueMapAllOfFromJSON(json: any): ProgrammaticScryptoSborValueMapAllOf;
export declare function ProgrammaticScryptoSborValueMapAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProgrammaticScryptoSborValueMapAllOf;
export declare function ProgrammaticScryptoSborValueMapAllOfToJSON(value?: ProgrammaticScryptoSborValueMapAllOf | null): any;
