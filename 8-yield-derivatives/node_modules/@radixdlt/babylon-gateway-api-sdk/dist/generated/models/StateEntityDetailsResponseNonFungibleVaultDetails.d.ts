 ...
 * @export
 */
export declare const StateEntityDetailsResponseNonFungibleVaultDetailsTypeEnum: {
 ...
 */
export declare function instanceOfStateEntityDetailsResponseNonFungibleVaultDetails(value: object): boolean;
export declare function StateEntityDetailsResponseNonFungibleVaultDetailsFromJSON(json: any): StateEntityDetailsResponseNonFungibleVaultDetails;
export declare function StateEntityDetailsResponseNonFungibleVaultDetailsFromJSONTyped(json: any, ignoreDiscriminator: boolean): StateEntityDetailsResponseNonFungibleVaultDetails;
export declare function StateEntityDetailsResponseNonFungibleVaultDetailsToJSON(value?: StateEntityDetailsResponseNonFungibleVaultDetails | null): any;
