 ...
 * @export
 */
export declare const ProgrammaticScryptoSborValueBytesAllOfKindEnum: {
 ...
 */
export declare function instanceOfProgrammaticScryptoSborValueBytesAllOf(value: object): boolean;
export declare function ProgrammaticScryptoSborValueBytesAllOfFromJSON(json: any): ProgrammaticScryptoSborValueBytesAllOf;
export declare function ProgrammaticScryptoSborValueBytesAllOfFromJSONTyped(json: any, ignoreDiscriminator: boolean): ProgrammaticScryptoSborValueBytesAllOf;
export declare function ProgrammaticScryptoSborValueBytesAllOfToJSON(value?: ProgrammaticScryptoSborValueBytesAllOf | null): any;
