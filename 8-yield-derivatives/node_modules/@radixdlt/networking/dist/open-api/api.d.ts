 ...
 * @enum {string}
 */
export declare enum TransactionStatusStatusEnum {
    Pending = "PENDING",
    Confirmed = "CONFIRMED",
    Failed = "FAILED"
}
...
export declare const AccountApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     */
    accountBalancesPost: (accountBalancesRequest: AccountBalancesRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    accountDerivePost: (accountDeriveRequest: AccountDeriveRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    accountStakesPost: (accountStakesRequest: AccountStakesRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    accountTransactionsPost: (accountTransactionsRequest: AccountTransactionsRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    accountUnstakesPost: (accountUnstakesRequest: AccountUnstakesRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const AccountApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    accountBalancesPost(accountBalancesRequest: AccountBalancesRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<AccountBalancesResponse>>;
    /**
     * Returns the account address associated with the given public key.
     * @summary Derive Account Identifier
     * @param {AccountDeriveRequest} accountDeriveRequest
     ...
     * @throws {RequiredError}
     */
    accountDerivePost(accountDeriveRequest: AccountDeriveRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<AccountDeriveResponse>>;
    /**
     * Returns the xrd which the account has in pending and active delegated stake positions with validators, given an account address. If an account address is valid, but doesn\'t have any ledger transactions against it, this endpoint still returns a successful response.
     * @summary Get Stake Positions
     * @param {AccountStakesRequest} accountStakesRequest
     ...
     * @throws {RequiredError}
     */
    accountStakesPost(accountStakesRequest: AccountStakesRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<AccountStakesResponse>>;
    /**
     * Returns user-initiated transactions involving the given account address which have been succesfully committed to the ledger. The transactions are returned in a paginated format, ordered by most recent. If an account address is valid, but doesn\'t have any ledger transactions against it, this endpoint still returns a successful response.
     * @summary Get Account Transactions
     * @param {AccountTransactionsRequest} accountTransactionsRequest
     ...
     * @throws {RequiredError}
     */
    accountTransactionsPost(accountTransactionsRequest: AccountTransactionsRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<AccountTransactionsResponse>>;
    /**
     * Returns the xrd which the account has in pending and temporarily-locked delegated unstake positions with validators, given an account address. If an account address is valid, but doesn\'t have any ledger transactions against it, this endpoint still returns a successful response.
     * @summary Get Unstake Positions
     * @param {AccountUnstakesRequest} accountUnstakesRequest
     ...
     * @throws {RequiredError}
     */
    accountUnstakesPost(accountUnstakesRequest: AccountUnstakesRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<AccountUnstakesResponse>>;
};
/**
...
export declare class AccountApi extends BaseAPI {
     ...
     * @memberof AccountApi
     */
    accountBalancesPost(accountBalancesRequest: AccountBalancesRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<AccountBalancesResponse, any>>;
    /**
     * Returns the account address associated with the given public key.
     * @summary Derive Account Identifier
     * @param {AccountDeriveRequest} accountDeriveRequest
     ...
     * @memberof AccountApi
     */
    accountDerivePost(accountDeriveRequest: AccountDeriveRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<AccountDeriveResponse, any>>;
    /**
     * Returns the xrd which the account has in pending and active delegated stake positions with validators, given an account address. If an account address is valid, but doesn\'t have any ledger transactions against it, this endpoint still returns a successful response.
     * @summary Get Stake Positions
     * @param {AccountStakesRequest} accountStakesRequest
     ...
     * @memberof AccountApi
     */
    accountStakesPost(accountStakesRequest: AccountStakesRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<AccountStakesResponse, any>>;
    /**
     * Returns user-initiated transactions involving the given account address which have been succesfully committed to the ledger. The transactions are returned in a paginated format, ordered by most recent. If an account address is valid, but doesn\'t have any ledger transactions against it, this endpoint still returns a successful response.
     * @summary Get Account Transactions
     * @param {AccountTransactionsRequest} accountTransactionsRequest
     ...
     * @memberof AccountApi
     */
    accountTransactionsPost(accountTransactionsRequest: AccountTransactionsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<AccountTransactionsResponse, any>>;
    /**
     * Returns the xrd which the account has in pending and temporarily-locked delegated unstake positions with validators, given an account address. If an account address is valid, but doesn\'t have any ledger transactions against it, this endpoint still returns a successful response.
     * @summary Get Unstake Positions
     * @param {AccountUnstakesRequest} accountUnstakesRequest
     ...
     * @memberof AccountApi
     */
    accountUnstakesPost(accountUnstakesRequest: AccountUnstakesRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<AccountUnstakesResponse, any>>;
}
/**
...
export declare const StatusApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    gatewayPost: (body: object, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const StatusApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    gatewayPost(body: object, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<GatewayResponse>>;
};
/**
...
export declare class StatusApi extends BaseAPI {
     ...
     * @memberof StatusApi
     */
    gatewayPost(body: object, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<GatewayResponse, any>>;
}
/**
...
export declare const TokenApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    tokenDerivePost: (tokenDeriveRequest: TokenDeriveRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    tokenNativePost: (tokenNativeRequest: TokenNativeRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    tokenPost: (tokenRequest: TokenRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
...
export declare const TokenApiFp: (configuration?: Configuration | undefined) => {
     ...
     * @throws {RequiredError}
     */
    tokenDerivePost(tokenDeriveRequest: TokenDeriveRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TokenDeriveResponse>>;
    /**
     * Returns information about XRD, including its Radix Resource Identifier.
     * @summary Get Native Token Info
     * @param {TokenNativeRequest} tokenNativeRequest
     ...
     * @throws {RequiredError}
     */
    tokenNativePost(tokenNativeRequest: TokenNativeRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TokenNativeResponse>>;
    /**
     * Returns information about any token, given its Radix Resource Identifier.
     * @summary Get Token Info
     * @param {TokenRequest} tokenRequest
     ...
     * @throws {RequiredError}
     */
    tokenPost(tokenRequest: TokenRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TokenResponse>>;
};
/**
...
export declare class TokenApi extends BaseAPI {
     ...
     * @memberof TokenApi
     */
    tokenDerivePost(tokenDeriveRequest: TokenDeriveRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TokenDeriveResponse, any>>;
    /**
     * Returns information about XRD, including its Radix Resource Identifier.
     * @summary Get Native Token Info
     * @param {TokenNativeRequest} tokenNativeRequest
     ...
     * @memberof TokenApi
     */
    tokenNativePost(tokenNativeRequest: TokenNativeRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TokenNativeResponse, any>>;
    /**
     * Returns information about any token, given its Radix Resource Identifier.
     * @summary Get Token Info
     * @param {TokenRequest} tokenRequest
     ...
     * @memberof TokenApi
     */
    tokenPost(tokenRequest: TokenRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TokenResponse, any>>;
}
/**
 * TransactionApi - axios parameter creator
 * @export
 */
export declare const TransactionApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    transactionBuildPost: (transactionBuildRequest: TransactionBuildRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    transactionFinalizePost: (transactionFinalizeRequest: TransactionFinalizeRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    transactionRecentPost: (recentTransactionsRequest: RecentTransactionsRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    transactionRulesPost: (transactionRulesRequest: TransactionRulesRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    transactionStatusPost: (transactionStatusRequest: TransactionStatusRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    transactionSubmitPost: (transactionSubmitRequest: TransactionSubmitRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * TransactionApi - functional programming interface
 * @export
 */
export declare const TransactionApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Returns a built unsigned transaction payload, from a set of intended actions.
     * @summary Build Transaction
     * @param {TransactionBuildRequest} transactionBuildRequest
     ...
     * @throws {RequiredError}
     */
    transactionBuildPost(transactionBuildRequest: TransactionBuildRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TransactionBuildResponse>>;
    /**
     * Returns a signed transaction payload and transaction identifier, from an unsigned transaction payload and signature.
     * @summary Finalize Transaction
     * @param {TransactionFinalizeRequest} transactionFinalizeRequest
     ...
     * @throws {RequiredError}
     */
    transactionFinalizePost(transactionFinalizeRequest: TransactionFinalizeRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TransactionFinalizeResponse>>;
    /**
     * Returns user-initiated transactions which have been succesfully committed to the ledger. The transactions are returned in a paginated format, ordered by most recent.
     * @summary Get Recent Transactions
     * @param {RecentTransactionsRequest} recentTransactionsRequest
     ...
     * @throws {RequiredError}
     */
    transactionRecentPost(recentTransactionsRequest: RecentTransactionsRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<RecentTransactionsResponse>>;
    /**
     * Returns the current rules used to build and validate transactions in the Radix Engine.
     * @summary Get Transaction Rules
     * @param {TransactionRulesRequest} transactionRulesRequest
     ...
     * @throws {RequiredError}
     */
    transactionRulesPost(transactionRulesRequest: TransactionRulesRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TransactionRulesResponse>>;
    /**
     * Returns the status and contents of the transaction with the given transaction identifier. Transaction identifiers which aren\'t recognised as either belonging to a committed transaction or a transaction submitted through this Network Gateway may return a `TransactionNotFoundError`. Transaction identifiers relating to failed transactions will, after a delay, also be reported as a `TransactionNotFoundError`.
     * @summary Transaction Status
     * @param {TransactionStatusRequest} transactionStatusRequest
     ...
     * @throws {RequiredError}
     */
    transactionStatusPost(transactionStatusRequest: TransactionStatusRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TransactionStatusResponse>>;
    /**
     * Submits a signed transaction payload to the network. The transaction identifier from finalize or submit can then be used to track the transaction status.
     * @summary Submit Transaction
     * @param {TransactionSubmitRequest} transactionSubmitRequest
     ...
     * @throws {RequiredError}
     */
    transactionSubmitPost(transactionSubmitRequest: TransactionSubmitRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<TransactionSubmitResponse>>;
};
/**
 * TransactionApi - factory interface
 * @export
 */
export declare const TransactionApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Returns a built unsigned transaction payload, from a set of intended actions.
     * @summary Build Transaction
     * @param {TransactionBuildRequest} transactionBuildRequest
...
export declare class TransactionApi extends BaseAPI {
     ...
     */
    transactionBuildPost(transactionBuildRequest: TransactionBuildRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TransactionBuildResponse, any>>;
    /**
     * Returns a signed transaction payload and transaction identifier, from an unsigned transaction payload and signature.
     * @summary Finalize Transaction
     * @param {TransactionFinalizeRequest} transactionFinalizeRequest
     ...
     * @memberof TransactionApi
     */
    transactionFinalizePost(transactionFinalizeRequest: TransactionFinalizeRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TransactionFinalizeResponse, any>>;
    /**
     * Returns user-initiated transactions which have been succesfully committed to the ledger. The transactions are returned in a paginated format, ordered by most recent.
     * @summary Get Recent Transactions
     * @param {RecentTransactionsRequest} recentTransactionsRequest
     ...
     * @memberof TransactionApi
     */
    transactionRecentPost(recentTransactionsRequest: RecentTransactionsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<RecentTransactionsResponse, any>>;
    /**
     * Returns the current rules used to build and validate transactions in the Radix Engine.
     * @summary Get Transaction Rules
     * @param {TransactionRulesRequest} transactionRulesRequest
     ...
     * @memberof TransactionApi
     */
    transactionRulesPost(transactionRulesRequest: TransactionRulesRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TransactionRulesResponse, any>>;
    /**
     * Returns the status and contents of the transaction with the given transaction identifier. Transaction identifiers which aren\'t recognised as either belonging to a committed transaction or a transaction submitted through this Network Gateway may return a `TransactionNotFoundError`. Transaction identifiers relating to failed transactions will, after a delay, also be reported as a `TransactionNotFoundError`.
     * @summary Transaction Status
     * @param {TransactionStatusRequest} transactionStatusRequest
     ...
     * @memberof TransactionApi
     */
    transactionStatusPost(transactionStatusRequest: TransactionStatusRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TransactionStatusResponse, any>>;
    /**
     * Submits a signed transaction payload to the network. The transaction identifier from finalize or submit can then be used to track the transaction status.
     * @summary Submit Transaction
     * @param {TransactionSubmitRequest} transactionSubmitRequest
     ...
     * @memberof TransactionApi
     */
    transactionSubmitPost(transactionSubmitRequest: TransactionSubmitRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<TransactionSubmitResponse, any>>;
}
/**
 * ValidatorApi - axios parameter creator
 * @export
 */
export declare const ValidatorApiAxiosParamCreator: (configuration?: Configuration | undefined) => {
    /**
     ...
     * @throws {RequiredError}
     */
    validatorDerivePost: (validatorDeriveRequest: ValidatorDeriveRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    validatorPost: (validatorRequest: ValidatorRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    validatorStakesPost: (validatorStakesRequest: ValidatorStakesRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
    /**
     ...
     * @throws {RequiredError}
     */
    validatorsPost: (validatorsRequest: ValidatorsRequest, options?: AxiosRequestConfig) => Promise<RequestArgs>;
};
/**
 * ValidatorApi - functional programming interface
 * @export
 */
export declare const ValidatorApiFp: (configuration?: Configuration | undefined) => {
    /**
     * Returns the validator address associated with the given public key.
     * @summary Get Validator Identifier
     * @param {ValidatorDeriveRequest} validatorDeriveRequest
     ...
     * @throws {RequiredError}
     */
    validatorDerivePost(validatorDeriveRequest: ValidatorDeriveRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ValidatorDeriveResponse>>;
    /**
     * Returns information about a validator, given a validator address. If a validator address is valid, but has not appeared on ledger as a validator, this endpoint still returns a successful response.
     * @summary Get Validator
     * @param {ValidatorRequest} validatorRequest
     ...
     * @throws {RequiredError}
     */
    validatorPost(validatorRequest: ValidatorRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ValidatorResponse>>;
    /**
     * Returns paginated results about the delegated stakes from accounts to a validator. The results are totalled by account, and ordered by account age (oldest to newest).
     * @summary Get Validator Stakes
     * @param {ValidatorStakesRequest} validatorStakesRequest
     ...
     * @throws {RequiredError}
     */
    validatorStakesPost(validatorStakesRequest: ValidatorStakesRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ValidatorStakesResponse>>;
    /**
     * Returns information about all validators.
     * @summary Get Validators
     * @param {ValidatorsRequest} validatorsRequest
     ...
     * @throws {RequiredError}
     */
    validatorsPost(validatorsRequest: ValidatorsRequest, options?: AxiosRequestConfig<any> | undefined): Promise<(axios?: AxiosInstance | undefined, basePath?: string | undefined) => AxiosPromise<ValidatorsResponse>>;
};
/**
 * ValidatorApi - factory interface
 * @export
 */
export declare const ValidatorApiFactory: (configuration?: Configuration | undefined, basePath?: string | undefined, axios?: AxiosInstance | undefined) => {
    /**
     * Returns the validator address associated with the given public key.
     * @summary Get Validator Identifier
     * @param {ValidatorDeriveRequest} validatorDeriveRequest
 ...
 * @extends {BaseAPI}
 */
export declare class ValidatorApi extends BaseAPI {
    /**
     * Returns the validator address associated with the given public key.
     * @summary Get Validator Identifier
     * @param {ValidatorDeriveRequest} validatorDeriveRequest
     ...
     */
    validatorDerivePost(validatorDeriveRequest: ValidatorDeriveRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ValidatorDeriveResponse, any>>;
    /**
     * Returns information about a validator, given a validator address. If a validator address is valid, but has not appeared on ledger as a validator, this endpoint still returns a successful response.
     * @summary Get Validator
     * @param {ValidatorRequest} validatorRequest
     ...
     * @memberof ValidatorApi
     */
    validatorPost(validatorRequest: ValidatorRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ValidatorResponse, any>>;
    /**
     * Returns paginated results about the delegated stakes from accounts to a validator. The results are totalled by account, and ordered by account age (oldest to newest).
     * @summary Get Validator Stakes
     * @param {ValidatorStakesRequest} validatorStakesRequest
     ...
     * @memberof ValidatorApi
     */
    validatorStakesPost(validatorStakesRequest: ValidatorStakesRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ValidatorStakesResponse, any>>;
    /**
     * Returns information about all validators.
     * @summary Get Validators
     * @param {ValidatorsRequest} validatorsRequest
     ...
     * @memberof ValidatorApi
     */
    validatorsPost(validatorsRequest: ValidatorsRequest, options?: AxiosRequestConfig): Promise<import("axios").AxiosResponse<ValidatorsResponse, any>>;
}
