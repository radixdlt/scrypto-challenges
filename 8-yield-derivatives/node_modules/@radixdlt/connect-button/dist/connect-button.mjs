import { css as I, LitElement as M, html as g, unsafeCSS as c } from "lit";
...
var xe = Object.defineProperty, be = Object.getOwnPropertyDescriptor, B = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? be(o, r) : o, s = e.length - 1, n; s >= 0; s--)
...
var De = Object.defineProperty, me = Object.getOwnPropertyDescriptor, O = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? me(o, r) : o, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (t = (i ? n(o, r, t) : n(t)) || t);
...
let C = class extends M {
  ...
  drawPopover() {
    const e = this.mode === "light" ? "#E7E7E7" : "#808080", o = this.height, r = 13, i = 8, t = 344, s = o, n = 12, D = n / 2, le = `
  ...
  render() {
    return this.isMobile ? g`<div id="radix-mobile-popover-content">
          <button
            id="close-button"
            @click=${() => {
      this.closePopover();
...
const Ce = 32, ye = 32, Q = 138, F = g`<div class="loading-spinner-container">
...
var ve = Object.defineProperty, we = Object.getOwnPropertyDescriptor, E = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? we(o, r) : o, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && ve(o, r, t), t;
};
let j = class extends M {
  constructor() {
    super(...arguments), this.status = L.default, this.connected = !1, this.fullWidth = !1, this.theme = "radix-blue";
  }
  onClick(e) {
    this.dispatchEvent(
      new CustomEvent("onClick", {
  ...
  disconnectedCallback() {
    ...
    const e = this.shadowRoot.querySelector("button");
    (o = this.resizeObserver) == null || o.unobserve(e);
  }
  render() {
    const e = () => this.status === L.pending && this.connected ? g`${F} <slot></slot>` : this.status === L.pending ? F : !this.connected && ["success", "error"].includes(this.status) ? "" : g`<slot></slot>`, o = this.status !== "pending" && !this.connected, r = this.connected;
    return g`
      <button
        @click=${this.onClick}
        class=${m({
...
var fe = Object.defineProperty, Le = Object.getOwnPropertyDescriptor, G = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Le(o, r) : o, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (t = (i ? n(o, r, t) : n(t)) || t);
...
let z = class extends M {
  ...
  render() {
    const e = () => this.timestamp ? g`<div class="timestamp">${ge(this.timestamp)}</div>` : "", o = `${this.icon ? "30px" : ""} 1fr ${this.timestamp ? "60px" : ""}`;
    return g`<div class="card" style=${se({ gridTemplateColumns: o })}>
      <i></i>
      <div class="content">
...
var Ze = Object.defineProperty, Oe = Object.getOwnPropertyDescriptor, U = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Oe(o, r) : o, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && Ze(o, r, t), t;
};
let Z = class extends M {
  constructor() {
  ...
  render() {
    return g`<a target="_blank" href=${this.href} class="link"
      >${this.displayText}
...
let v = class extends M {
  ...
  render() {
    return g` <span class="label">${this.label}</span>
      <a
        class="address"
        target="_blank"
        href=${`${this.address}`}
...
var Ge = Object.defineProperty, Ye = Object.getOwnPropertyDescriptor, h = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Ye(o, r) : o, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (t = (i ? n(o, r, t) : n(t)) || t);
...
let x = class extends M {
  ...
  getRequestContentTemplate(e) {
    return this.status === "pending" ? g`<div class="request-content">
          ${e}
  ...
  renderTxIntentHash() {
    return this.transactionIntentHash ? g`<div class="transaction">
...
var We = Object.defineProperty, Qe = Object.getOwnPropertyDescriptor, H = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Qe(o, r) : o, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (t = (i ? n(o, r, t) : n(t)) || t);
...
var Ue = Object.defineProperty, Xe = Object.getOwnPropertyDescriptor, T = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Xe(o, r) : o, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && Ue(o, r, t), t;
};
let b = class extends M {
  constructor() {
    super(...arguments), this.mode = A.light, this.isMobile = !1, this.status = L.default, this.isWalletLinked = !1, this.isExtensionAvailable = !1, this.requestItems = [];
  }
  render() {
    let e = this.renderConnectTemplate();
    return this.isMobile ? e = this.renderMobileTemplate() : this.isExtensionAvailable ? this.isWalletLinked ? this.status === L.pending && (e = this.renderRequestItemsTemplate()) : e = this.renderCeNotLinkedTemplate() : e = this.renderCeNotInstalledTemplate(), g`
  ...
  renderMobileTemplate() {
    return g` <div class="mobile-wrapper">
  ...
  renderConnectTemplate() {
    return g` ${this.connectNowButtonTemplate()} `;
  }
};
b.styles = [
  p,
...
var He = Object.defineProperty, Re = Object.getOwnPropertyDescriptor, S = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Re(o, r) : o, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (t = (i ? n(o, r, t) : n(t)) || t);
...
let y = class extends M {
  ...
  render() {
    return g`<radix-card mode=${this.mode}>
      <div
        class=${m({
      ...
      backgroundImage: `url(${c(this.avatarUrl)})`
        ...
        <div class="content">
          ...
          <ul>
            ${(this.personaData || []).map((e) => g`<li>${e}</li>`)}
          </ul>
        </div>
      </div></radix-card
    >`;
...
`;
var Ve = Object.defineProperty, Je = Object.getOwnPropertyDescriptor, f = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Je(o, r) : o, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && Ve(o, r, t), t;
};
let N = class extends M {
  ...
  render() {
    return g` <div class="header">Sharing with ${this.dAppName}</div>
      <div class="content">
        <radix-persona-card
        ...
        <div>
          ${(this.accounts || []).map(
      ({ label: e, address: o, appearanceId: r }) => g`<radix-account
                label=${e}
                address=${o}
                appearanceId=${r}
              ></radix-account>`
  ...
  render() {
    return g`
      ...
      ${this.loggedInTimestamp ? g`<div class="subheader">
            Since logged in: ${ge(this.loggedInTimestamp, ", ")}
          </div>` : ""}
      <div class="content">
...
var Ke = Object.defineProperty, $e = Object.getOwnPropertyDescriptor, l = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? $e(o, r) : o, s = e.length - 1, n; s >= 0; s--)
    (n = e[s]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && Ke(o, r, t), t;
};
let d = class extends M {
  constructor() {
    super(), this.theme = "radix-blue", this.dAppName = "", this.personaLabel = "", this.connected = !1, this.status = L.default, this.loggedInTimestamp = "", this.showPopoverMenu = !1, this.requestItems = [], this.accounts = [], this.personaData = [], this.isMobile = !1, this.isWalletLinked = !1, this.isExtensionAvailable = !1, this.fullWidth = !1, this.activeTab = "sharing", this.mode = "light", this.avatarUrl = "", this.compact = !1, this.windowClickEventHandler = (e) => {
  ...
  connectTemplate() {
    if (!this.connected)
      return g` <radix-not-connected-page
      mode=${this.mode}
      status=${this.status}
  ...
  popoverTemplate() {
    return this.showPopoverMenu ? g` <radix-popover
      mode="${this.mode}"
      ?connected=${this.connected}
  ...
  render() {
    return g`${this.connectButtonTemplate()} ${this.popoverTemplate()}`;
  }
};
d.styles = I`
...
export {
  ...
  L as RadixButtonStatus,
  rt as RadixButtonTheme,
  nt as RequestItemType,
  at as RequestStatus
};
