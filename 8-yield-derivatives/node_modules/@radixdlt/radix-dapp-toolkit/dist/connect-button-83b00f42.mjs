import { css as l, unsafeCSS as c, html as s, LitElement as M } from "lit";
import { property as a, customElement as u, state as pe } from "lit/decorators.js";
import { classMap as m } from "lit/directives/class-map.js";
import { styleMap as ge } from "lit/directives/style-map.js";
import { classMap as Ae } from "lit-html/directives/class-map.js";
l`
  :host {
    /* Core colors */
...
var xe = Object.defineProperty, be = Object.getOwnPropertyDescriptor, B = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? be(o, r) : o, g = e.length - 1, n; g >= 0; g--)
    (n = e[g]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && xe(o, r, t), t;
};
let O = class extends M {
  constructor() {
    super(...arguments), this.theme = A.light, this.active = "sharing";
  }
  onClick(e, o) {
    this.dispatchEvent(
...
var De = Object.defineProperty, me = Object.getOwnPropertyDescriptor, Z = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? me(o, r) : o, g = e.length - 1, n; g >= 0; g--)
    (n = e[g]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && De(o, r, t), t;
};
let y = class extends M {
  constructor() {
    super(...arguments), this.mode = A.light, this.connected = !1, this.compact = !1, this.isMobile = !1, this.height = 0;
  }
  connectedCallback() {
  ...
  drawPopover() {
    const e = this.mode === "light" ? "#E7E7E7" : "#808080", o = this.height, r = 13, i = 8, t = 344, g = o, n = 12, D = n / 2, Ie = `
      ...
      </linearGradient>`, le = (X, R, V) => `
      L ${X - V} ${R} 
      L ${X} 1
      L ${X + V} ${R}`, Me = this.compact ? t - 30 : 300, ue = `
    ...
    `;
    return `data:image/svg+xml;base64,${Ne(ue)}`;
  }
  render() {
    return this.isMobile ? s`<div id="radix-mobile-popover-content">
          <button
            id="close-button"
            @click=${() => {
      this.closePopover();
...
const ye = 32, je = 32, Q = 138, F = s`<div class="loading-spinner-container">
...
let h = class extends M {
  ...
  render() {
    const e = () => this.status === k.pending && this.connected ? s`${F} <slot></slot>` : this.status === k.pending ? F : !this.connected && ["success", "error"].includes(this.status) ? "" : s`<slot></slot>`, o = this.status !== "pending" && !this.connected, r = this.connected;
    return s`
      <button
        @click=${this.onClick}
        class=${m({
...
var fe = Object.defineProperty, Ze = Object.getOwnPropertyDescriptor, U = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Ze(o, r) : o, g = e.length - 1, n; g >= 0; g--)
    (n = e[g]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && fe(o, r, t), t;
};
let f = class extends M {
  constructor() {
    super(...arguments), this.mode = A.light, this.href = "", this.displayText = "";
  }
  render() {
    return s`<a target="_blank" href=${this.href} class="link"
      >${this.displayText}
...
], v.prototype, "appearanceId", 2);
v = Y([
  u("radix-account")
], v);
var Ge = Object.defineProperty, Ye = Object.getOwnPropertyDescriptor, C = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Ye(o, r) : o, g = e.length - 1, n; g >= 0; g--)
    (n = e[g]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && Ge(o, r, t), t;
};
let x = class extends M {
  constructor() {
    super(...arguments), this.mode = A.light, this.type = "dataRequest", this.status = "pending", this.showCancel = !1, this.timestamp = "", this.id = "", this.transactionIntentHash = "";
  }
  render() {
    const e = this.getIconFromStatus(), o = this.getStylingFromStatus(), r = {
      sendTransaction: {
    ...
    return s`<radix-card
      ...
      header="${r[this.type][this.status]}"
    >
      ${r[this.type].content}
    </radix-card>`;
  }
  getRequestContentTemplate(e) {
    return this.status === "pending" ? s`<div class="request-content">
          ${e}
          ${this.showCancel ? s`<div class="cancel" @click=${this.onCancel}>Cancel</div>` : ""}
        </div>` : "";
  }
  getIconFromStatus() {
  ...
  renderTxIntentHash() {
    return this.transactionIntentHash ? s`<div class="transaction">
          <span class="text-dimmed">ID:</span>
          <radix-link
            displayText="${ce(this.transactionIntentHash)}"
            mode=${this.mode}
            @click=${(e) => {
      e.preventDefault(), this.dispatchEvent(
        new CustomEvent("onLinkClick", {
...
x = C([
  u("radix-request-card")
], x);
var We = Object.defineProperty, Qe = Object.getOwnPropertyDescriptor, H = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Qe(o, r) : o, g = e.length - 1, n; g >= 0; g--)
    (n = e[g]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && We(o, r, t), t;
};
let P = class extends M {
  constructor() {
    super(...arguments), this.mode = A.light, this.requestItems = [];
  }
  render() {
    return (this.requestItems || []).map(
      (e) => s`<radix-request-card
        type="${e.type}"
        status="${e.status}"
        id="${e.id}"
...
H([
  a({ type: Array })
], P.prototype, "requestItems", 2);
P = H([
  u("radix-request-cards")
], P);
var Ue = Object.defineProperty, Xe = Object.getOwnPropertyDescriptor, T = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Xe(o, r) : o, g = e.length - 1, n; g >= 0; g--)
    (n = e[g]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && Ue(o, r, t), t;
};
let b = class extends M {
  constructor() {
    super(...arguments), this.mode = A.light, this.isMobile = !1, this.status = k.default, this.isWalletLinked = !1, this.isExtensionAvailable = !1, this.requestItems = [];
  }
  render() {
    let e = this.renderConnectTemplate();
    return this.isMobile ? e = this.renderMobileTemplate() : this.isExtensionAvailable ? this.isWalletLinked ? this.status === k.pending && (e = this.renderRequestItemsTemplate()) : e = this.renderCeNotLinkedTemplate() : e = this.renderCeNotInstalledTemplate(), s`
  ...
  renderMobileTemplate() {
    return s` <div class="mobile-wrapper">
  ...
  renderConnectTemplate() {
    return s` ${this.connectNowButtonTemplate()} `;
  }
};
b.styles = [
  p,
...
var He = Object.defineProperty, Re = Object.getOwnPropertyDescriptor, S = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Re(o, r) : o, g = e.length - 1, n; g >= 0; g--)
    (n = e[g]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && He(o, r, t), t;
};
let j = class extends M {
  constructor() {
    super(...arguments), this.mode = A.light, this.persona = "", this.personaData = [];
  }
  render() {
    return s`<radix-card mode=${this.mode}>
      <div
        class=${m({
      ...
      avatar: !!this.avatarUrl
            ...
            style=${ge({
      backgroundImage: `url(${c(this.avatarUrl)})`
    })}
          ></div>
        </div>
        <div class="content">
          ...
          <ul>
            ${(this.personaData || []).map((e) => s`<li>${e}</li>`)}
          </ul>
        </div>
      </div></radix-card
    >`;
...
`;
var Ve = Object.defineProperty, Je = Object.getOwnPropertyDescriptor, L = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? Je(o, r) : o, g = e.length - 1, n; g >= 0; g--)
    (n = e[g]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && Ve(o, r, t), t;
};
let N = class extends M {
  constructor() {
    super(...arguments), this.mode = A.light, this.avatarUrl = "", this.persona = "", this.dAppName = "", this.personaData = [], this.accounts = [];
  }
  onUpdateData(e) {
    this.dispatchEvent(
  ...
  render() {
    return s` <div class="header">Sharing with ${this.dAppName}</div>
      <div class="content">
        <radix-persona-card
        ...
        <div>
          ${(this.accounts || []).map(
      ({ label: e, address: o, appearanceId: r }) => s`<radix-account
                label=${e}
                address=${o}
                appearanceId=${r}
              ></radix-account>`
...
N.styles = [
  ...
  l`
      ...
      #update-data::before {
        -webkit-mask-image: url(${c(ae)});
        mask-image: url(${c(ae)});
      }

      #logout::before {
        -webkit-mask-image: url(${c(ne)});
        mask-image: url(${c(ne)});
      }
    `
];
...
], N.prototype, "avatarUrl", 2);
L([
  a({
    type: String
  })
], N.prototype, "persona", 2);
L([
  a({
    type: String
  })
], N.prototype, "dAppName", 2);
L([
  a({
    type: Array
  })
], N.prototype, "personaData", 2);
L([
  a({
    type: Array
  })
], N.prototype, "accounts", 2);
N = L([
  u("radix-sharing-page")
], N);
var Fe = Object.defineProperty, qe = Object.getOwnPropertyDescriptor, W = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? qe(o, r) : o, g = e.length - 1, n; g >= 0; g--)
    (n = e[g]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && Fe(o, r, t), t;
};
let w = class extends M {
  constructor() {
    super(...arguments), this.mode = A.light, this.requestItems = [], this.dAppName = "", this.loggedInTimestamp = "";
  }
  render() {
    return s`
      <div class="header">Connected to ${this.dAppName}</div>
      <slot name="subheader"></slot>
      ${this.loggedInTimestamp ? s`<div class="subheader">
            Since logged in: ${se(this.loggedInTimestamp, ", ")}
          </div>` : ""}
      <div class="content">
...
], w.prototype, "dAppName", 2);
W([
  a({
    type: String
  })
], w.prototype, "loggedInTimestamp", 2);
w = W([
  u("radix-requests-page")
], w);
var Ke = Object.defineProperty, $e = Object.getOwnPropertyDescriptor, I = (e, o, r, i) => {
  for (var t = i > 1 ? void 0 : i ? $e(o, r) : o, g = e.length - 1, n; g >= 0; g--)
    (n = e[g]) && (t = (i ? n(o, r, t) : n(t)) || t);
  return i && t && Ke(o, r, t), t;
};
let d = class extends M {
  constructor() {
    super(), this.theme = "radix-blue", this.dAppName = "", this.personaLabel = "", this.connected = !1, this.status = k.default, this.loggedInTimestamp = "", this.showPopoverMenu = !1, this.requestItems = [], this.accounts = [], this.personaData = [], this.isMobile = !1, this.isWalletLinked = !1, this.isExtensionAvailable = !1, this.fullWidth = !1, this.activeTab = "sharing", this.mode = "light", this.avatarUrl = "", this.compact = !1, this.windowClickEventHandler = (e) => {
  ...
  connectTemplate() {
    if (!this.connected)
      return s` <radix-not-connected-page
      mode=${this.mode}
      status=${this.status}
  ...
  popoverTemplate() {
    return this.showPopoverMenu ? s` <radix-popover
      mode="${this.mode}"
      ?connected=${this.connected}
  ...
  render() {
    return s`${this.connectButtonTemplate()} ${this.popoverTemplate()}`;
  }
};
d.styles = l`
...
I([
  a({ type: String })
], d.prototype, "personaLabel", 2);
I([
  a({ type: Boolean })
], d.prototype, "connected", 2);
I([
  a({
    type: String
  })
...
I([
  a({ type: String })
], d.prototype, "loggedInTimestamp", 2);
I([
  a({ type: Boolean })
], d.prototype, "showPopoverMenu", 2);
I([
  a({ type: Array })
], d.prototype, "requestItems", 2);
I([
  a({ type: Array })
...
], d.prototype, "isWalletLinked", 2);
I([
  a({
    type: Boolean
  })
], d.prototype, "isExtensionAvailable", 2);
I([
  a({
    type: Boolean
  })
...
I([
  a({ type: Boolean, state: !0 })
], d.prototype, "compact", 2);
d = I([
  u("radix-connect-button")
], d);
export {
  d as ConnectButton,
  A as RadixButtonMode,
