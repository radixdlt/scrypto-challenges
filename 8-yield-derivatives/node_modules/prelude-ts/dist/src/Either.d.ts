 ...
 */
export declare class EitherStatic {
    /**
     ...
     */
    liftAp<L, A, B>(fn: (x: A) => B, leftWitness?: L): (x: {
        [K in keyof A]: Either<L, A[K]>;
    }) => Either<L, B>;
    /**
     * Applicative lifting for Either. 'p' stands for 'properties'.
     ...
     * @param B the type returned by your function, returned wrapped in an either by liftAp.
     */
    liftApAcc<L, A, B>(fn: (x: A) => B, leftWitness?: L): (x: {
        [K in keyof A]: Either<L, A[K]>;
    }) => Either<Vector<L>, B>;
    /**
 ...
 */
export declare const Either: EitherStatic;
/**
 ...
 */
export declare class Left<L, R> implements Value {
    private value;
    constructor(value: L);
    /**
     * @hidden
     */
    readonly className: "Left";
    /**
 ...
 * @param R the "right" item type 'success'
 */
export declare class Right<L, R> implements Value {
    private value;
    constructor(value: R);
    /**
     * @hidden
     */
    readonly className: "Right";
    /**
