...
pub struct BurnYieldNFTEvent {
    ...
    pub burnt_hour_of_mint: u64,
    pub burnt_n_super_minted: u64,
    pub burnt_n_trust_minted: Decimal,
}
...
pub struct YieldUpdateEvent {
    pub time: u64, // Example field: time at which the update occurred
    pub nft_id: u64,
...
pub struct CurrentSaleStatusEvent {
    pub sale_currently_active: bool, // Example field: time at which the update occurred
}
