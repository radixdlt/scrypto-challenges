...
#admin desagree to pay following the claim
...
echo "CALL_METHOD ComponentAddress(\"$RAD_INSURANCE_COMPONENT_ADDRESS\") \"make_claim_as_refused\"  $RAD_INSURANCE_POLICY_ID_U128 NonFungibleLocalId(\"$RAD_INSURANCE_INSURED_CLAIM_BADGE_ID\") ;" >> tx.rtm
