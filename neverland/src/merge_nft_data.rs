...
// Asset NFT Merge Data Component
blueprint! {
    struct NeverlandMergeNftData {
        minter_badge: Vault,
    ...
    impl NeverlandMergeNftData {
        pub fn new() -> (ComponentAddress,Bucket){
            ...
            let mut neverland_nft_data: NeverlandMergeNftDataComponent = Self {
        ...
        pub fn check_svg_data(&mut self) -> HashMap<String,Vec<(u128,String)>> {
            ...
            fn process_data(&mut self, seed: u128) -> (u128,u128,u128,u128){
                let (data_e,num_f) = NeverlandMergeNftData::extract_code(seed,6);
                let (data_f,num_g) = NeverlandMergeNftData::extract_code(num_f,4);
                let (data_g,_num_h) = NeverlandMergeNftData::extract_code(num_g,2);
        ...
        pub fn asset_data_for(&mut self, seed: String, auth: Proof) -> (String,String) {
            ...
            // Match return value
            let sh = match h {
                30 => "01010102".to_string(),    31 => "01010201".to_string(),  32 => "01020103".to_string(),      
                33 => "01020202".to_string(),    34 => "01020101".to_string(),  35 => "01030102".to_string(),    
                36 => "01030203".to_string(),    37 => "02010101".to_string(),  38 => "02010202".to_string(), 
                9 => "02010301".to_string(),    10 => "02020203".to_string(),  11 => "02020201".to_string(), 
                12 => "02020102".to_string(),   13 => "02020302".to_string(),  14 => "02030202".to_string(), 
                15 => "02030103".to_string(),   16 => "02030303".to_string(),  17 => "03010302".to_string(), 
                18 => "03010201".to_string(),   19 => "03020303".to_string(),  20 => "03020301".to_string(), 
                21 => "03020202".to_string(),   22 => "03030302".to_string(),  23 => "03030203".to_string(), 
                _ => "".to_string()
